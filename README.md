...
### [Telematics Insurance Real-Time Analytics](https://github.com/jmDarcy/telematics_insurance_project)
...
### [Markowitz Cardinality Metaheuristics](https://github.com/jmDarcy/markowitz-cardinality-metaheuristics)
...
### [Survival Analysis of Heart Failure Records](https://github.com/jmDarcy/survival-analysis-heart-failure)
...
### [Simple Bayesian Models](https://github.com/jmDarcy/simple-bayesian-models)
...
### [Airline Passenger Satisfaction Classification](https://github.com/jmDarcy/data-mining-airline-satisfaction)
...
- Prophet-based actuarial model testing and validation in life insurance.
...
- Website: [jakubmikolajczak.pl](https://jakubmikolajczak.pl/)
- LinkedIn: [Jakub Mikolajczak](https://www.linkedin.com/in/jakub-miko%C5%82ajczak-913b5a1a1/)
- GitHub: [jmDarcy](https://github.com/jmDarcy)
- CV: `[add CV link]`
